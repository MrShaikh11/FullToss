        ...
        >
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                href="#"
                className={`flex items-center p-2 font-bold text-gray-900 rounded-lg dark:text-white hover:bg-${userColor}-100 dark:hover:bg-${userColor}-700 group`}
              >
                <svg
                ...
                <span
                  className={`inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-${userColor}-800 bg-${userColor}-100 rounded-full dark:bg-${userColor}-900 dark:text-${userColor}-300`}
                >
                  3
                </span>
              </a>
